...
import logo from "../assets/private/centre.png"

export default class ListRadioCenters extends React.Component {
  constructor(props) {
    super(props);
...

            {
              ...
              (<TextInput
                ...
                <Text style={styles.toolbarTitle}>
                  Liste des centres radiologiques
                </Text>
              )
            }
            
            <TouchableOpacity ref={input => {this.appTourTarget = input}} style={{ padding: 10 }} onPress={()=>{this._showSearchStructures()}}>
              {
                this.state.searchStructuresRequested?
                (
