...
const AppMainContainer=createMaterialBottomTabNavigator(
    ...
    Home: {
      ...
      navigationOptions: {
        ...
        tabBarIcon: ({ tintColor }) => (
          <FontAwesome name="address-book-o" color={"#ffff"} size={20} />
        )
      }
    },
    Organizations: {
      ...
      navigationOptions: {
        ...
        tabBarIcon: ({ tintColor }) => (
          <FontAwesome name="building-o" color={"#ffff"} size={20} />
        )
      }
    },
  ...
  },
  {
    ...
    barStyle: {
      backgroundColor: constants.colors.toolBar//"#003d33"//"#E1F5FE"//#B3E5FC,
    },
