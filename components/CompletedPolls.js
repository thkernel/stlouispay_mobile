...
export default class CompletedPolls extends Component {
  
constructor(props) {
    super(props);

    this.state = {
      loadingCompletedPolls:true,
      completedPolls: null,
...
_requestPollDetails = async (poll) => {
...
_renderCompletedPolls() {
        if (this.props.completedPolls != null && this.props.completedPolls != undefined && this.props.completedPolls.length > 0) {
          
          return (
            this.props.completedPolls.map( (pollItem,index) => {
                return(
                   <ListItem avatar key={index} onPress={()=> {                
                     this._showPollResult(pollItem);
          ...
          const height =
            ...
            if(this.props.loadingCompletedPolls){
              return (
                <View style={{ flex: 1, alignItems: "center", marginTop: height }}>
                  <ActivityIndicator size="large"/>
                </View>
              );
            }else if(this.props.completedPollsEmpty){
              return (
